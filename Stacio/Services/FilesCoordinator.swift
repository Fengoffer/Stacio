...
extension FilesCoordinator {
    var documentMediaWindowCountForTesting: Int {
        documentCoordinator.mediaWindowCountForTesting
    }

    var documentMediaSourceURLsForTesting: [URL] {
        documentCoordinator.mediaSourceURLsForTesting
    }
